  ...
  return (
    <footer className="bg-romantic-900 py-20 px-4 text-center border-t-4 border-gold-dark/40">
      <div className="max-w-4xl mx-auto flex flex-col items-center">
        <p className="mb-7 max-w-3xl mx-auto px-6 py-4 md:px-8 md:py-5 text-center leading-relaxed rounded-2xl border border-gold-light/20 bg-white/[0.03] backdrop-blur-sm shadow-[0_0_26px_rgba(255,215,160,0.1)]">
          ...
          <span className="block mt-3 text-gold-light/95 text-[0.74rem] md:text-[0.84rem] font-sans font-bold tracking-[0.16em]">
            Matthew 19:6
          </span>
        </p>
